...
public class Read{
//Odczytuje i zapisuje do tablicy wartoœci szybkoœci fali têtna z pliku
  ...
  public float[] read(String filename, int diff1, int diff2) throws FileNotFoundException{
